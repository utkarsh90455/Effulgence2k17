   ...
   <div class="row">
    <form class="col s12" method="post" action="cam_reg.php" enctype="multipart/form-data">
       ...
       <!-- <i class="material-icons prefix">event_seat</i>-->
        ...
        <label for="work_experience">Works Experience of any Tech Fest </label>
        </div>
        <div class="input-field col s12">
        ...
        <p class="center"><button type="submit" class="waves-effect waves-light btn green" >Submit</button>&nbsp;<a type="button" class="modal-close waves-effect waves-light btn red">Not Now</a><br/></p>
    </form>
    </div>
</div>
</div>
