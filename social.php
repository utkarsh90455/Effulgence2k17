      ...
      <ul class="nav navbar-nav abc">
        ...
        <li><a href="aboutus.php">About us</a></li>
           <li><a href="pronites.php">Pronites</a></li>
            ...
            <li id="hide2"><a href="#"> <img  src="img/neon1.png" height="90" width="90" style="margin-right:px; margin-left:px;  margin-top:px;"   /></a></li>
  ...
  <div class="col-lg-12 col-sm-12 col-md-12">
   <div class="col-lg-3 col-sm-3 col-md-3"></div> 
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
          NEW BEGINNING <span class="name"></span>
          <div class="row"></div>         
        </div>  
      </div>
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
         KNIT INNOVATION CHALLENGE<span class="name"></span>
          <div class="row"></div>         
        </div>  
      </div>
