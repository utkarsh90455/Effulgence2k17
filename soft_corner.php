...
<center> <h3>Software Corner</h3> </center> 
    </div>
   <!--scoll area start-->
...
<div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="debugging.php" target="_blank"></a>            
    </div>
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="math_mongo.php" target="_blank"></a> 
    </div>
    
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
         APPFUN <span class="name"></span>
          <div class="row"></div>          
        </div>
      </div>
      ...
      <a class="link" href="app.php" target="_blank"></a>  
    </div>  
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
          BERMUDA TRIANGLE <span class="name"></span>
          <div class="row"></div>          
        </div>  
      </div>
      <div class="box-overlay magictime" data-hover="rotateRight" data-return="">
      ...
      <a class="link" href="BERMUDA.php" target="_blank"></a>       
    </div>  
    </div>
  ...
  <div class="col-lg-12 col-sm-12 col-md-12">
   <div class="col-lg-3 col-sm-3 col-md-3"></div> 
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="codigo.php" target="_blank"></a>              
    </div>  
    
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
          HACKATHON <span class="name"></span>
          <div class="row"></div>         
        </div>  
      </div>
      <div class="box-overlay magictime" data-hover="rotateLeft" data-return="">
      ...
      <a class="link" href="HACKATHON.php" target="_blank"></a>                    
    </div>                
