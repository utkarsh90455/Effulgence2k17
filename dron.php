...
<center> <h3>DRONE-STRIFE </h3> </center> 
    </div>
   <!--scoll area start-->
...
<!--==========.=============================================================================================-->
<h2>INTRODUCTION :</h2>
<p>To design & fabricate a manual multi-copter(Quadcopter, Hexacopter, Octacopter)
which can complete given tasks.

</p><br>

 <center><p>For more Information: </p><a href="work/dronestrife.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center><?php $eid='dro';include_once "reg_inc.php";?>
