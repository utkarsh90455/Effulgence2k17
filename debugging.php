...
<h2>INTRODUCTION :</h2>
<p>It is an individual event and is a single level event .
In each level there will be a problem statement along with the solution which contain some bugs .
Participants have to find the bug and rectify the code so as to get the desired output . </p><br>
<h2>NOTE :</h2>
<p>1. Any participant found indulged in any unfair means will be immediately disqualified from the event.<br>
2. In case of tie between two participants, time will be the determining factor.</p><br>
<h2> Event Co-ordinators</h2>
<p>Ramendra Singh (Final Year)</p>  
<p>Atul Verma (8127587875)</p>
<p>Divyansh Srivastava (7238987933)</p>


 <!--=========================================================================================================-->
 <center><?php $eid='deb';include_once "reg_inc.php";?>
