...
<div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="apoline.php" target=""></a>            
    </div>
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="MATBUZZ.php" target=""></a> 
    </div>
    
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
         JUNKYARD <span class="name"></span>
          <div class="row"></div>          
        </div>
      </div>
      ...
      <a class="link" href="JUNKYARD.php" target=""></a>  
    </div>  
