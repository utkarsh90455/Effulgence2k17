...
<h2>INTRODUCTION :</h2>
<p>
Wall-E(Construct a Manual Bot) de novo becomes a great rescuer. He had preserved the Eva from all bother predicament.
There was a herd of stymied but Wall-E’s scintillating heroism and meticulously exhumed the Eva.
He had gone against the danger, encountered hazardous militants and crinkled mystify in his path.
Wall-E some time siege with profligate and created a plight ballgame.
</p></br>




  <center><p>For more Information: </p><a href="work/wall_e.pdf"><button class="sunny">Download</button></a></center>
<center><iframe width="550" height="305" src="https://www.youtube.com/embed/SOWicOnw2Tg" frameborder="0" allowfullscreen></iframe></center>

 <!--=========================================================================================================-->
 <center><?php $eid='wae';include_once "reg_inc.php";?>
