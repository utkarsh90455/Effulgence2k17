...
<p>
This is a online team event comprising of 2 or 3 members.
Each team will have to choose a problem from the given set and make an app according to the given constraints in specified time.
Interested teams will have to send main file in zip format to email : <u>araghav47@gmail.com</u> and <u>shubh3695@gmail.com</u> with their team name as subject and members details attached in a text file with it.<br><br>
<b>The problem sets are:</b></br>
<p>
1)A Calculator<br>
2)Diary(Online/Offline)<br>
3)Music Player<br> <br> 
Marks will be given based on Creativity,UI/UX,Bug Free.Include as many features as you can.
You will also have to give a presentation based on your project at the end.</br></br>
The presentation will be offline by any member of the team.</br>
Last Date For Submission: 9 Oct 2017, 23:59 </br>
Presentation will  be on 11 Oct 2017.</br>
<center><b >Prize Worth: &#x20b9;3,000</b></center>
</p><br>

For Query:<br>
Raghav Agarwal (9759350985)
</p> 


 <!--=========================================================================================================-->
 <center> <?php $eid='app';include_once "reg_inc.php";?>
<a href="soft_corner.php"><button class="sunny">Back</button></a>
