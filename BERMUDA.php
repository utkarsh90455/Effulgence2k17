...
<center> <h3>BERMUDA TRIANGLE </h3> </center> 
    </div>
   <!--scoll area start-->
...
The event comprises of breaking into a sandboxed virtual network using well known exploits to retrieve files or modify permissions. .=============================================================================================-->
...
problem for exactly 10 minutes, at the end of which, the team members will be required to switch
over to the fellow teammate's terminal and continue from the point left by the other teammate.
</p> 

<center><p>For more Information: </p><a href="work/bermuda.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center>
<?php $eid='btr';include_once "reg_inc.php";?><br>
  <div class="area1">
<center> <h3>CODEARENA </h3> </center> 
    </div>
<p>CODEARENA is the second round  of the BERMUDA TRIANGLE . </p>
<center><p>For more Information: </p><a href="code_night.php"><button class="sunny">Click&nbsp;Here</button></a></center>
