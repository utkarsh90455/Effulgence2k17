...
<?php if($_GET['temp']=="res")
{
echo '<center><p style="color:red;">For Registration Please Login First ...</p></center>';
} ?>
...
<span class="log1">E-mail:</span><br /><br />
<input type='text' class="log2" placeholder="Enter email-id" name='email'/><br /><br />
<span class="log1">Password:</span><br /><br />
<input type='password'class="log2"  placeholder="Enter password" name='pass'/><?php if(@$_GET['q']) echo'<br /><br /><span class="log1" style="color:red;">*'. @$_GET['q'];?><br /><br /></span><input type='submit' class="log2 submit"  value='Submit'/>
</form></div>
