...
<center> <h3>COUNTER STRIKE</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Counter-Strike is a series of multiplayer first-person shooter video games, in which teams of terrorists and counter-terrorists battle to, respectively, perpetrate an act of terror and prevent it.
</p>
<p>Entry Fees :</br>
1. 150  Rs for girls' team for all years.</br>
2. 250  Rs for Ist year teams .</br>
3. 500  Rs each for rest of years.</br>
</p>
<center><b >1st Prize : &#x20b9;5,000</b></center>
<center><b >2nd Prize : &#x20b9;3,000</b></center>
</br>
  ...
  <center><p>For more Information: </p><a href="work/counter.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center>
  <?php $eid='cst';include_once "reg_inc.php";?><a href="game.php"><button class="sunny">Back</button></a>
