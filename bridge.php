...
<h2>INTRODUCTION :</h2>
<p>Design a truss bridge using popsicle stricks satisfying the stated contraint . </p></br>
<center><b >Prize : &#x20b9;10,000</b></center>
  <center><p>For more Information: </p><a href="work/BRIDGEIT.pdf"><button class="sunny">Download</button></a></center>



 <!--=========================================================================================================-->
 <center><?php $eid='bdi';include_once "reg_inc.php";?>
<a href="concretus.php"><button class="sunny">Back</button></a>
