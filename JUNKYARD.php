...
<center> <h3>JUNKYARD</h3> </center> 
    </div>
   <!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">

<!--=======================================================================================================-->
<center><p>If the presence of electricity can be made visible in any part of the circuit, I see no reason why intelligence may not be transmitted instantaneously by electricity. - Samuel Morse</p></center>
<p>
Are you the next Tesla, Faraday or Volta? Want the next SI unit to be named after you? Is the electronics lab your 2nd home? Do you have a penchant for circuits? Here’s your chance to showcase your electrifying skills and grab cool prizes


</p>
 <center><p>For more Information: </p><a href="work/junkyard.pdf"><button class="sunny">Download</button></a></center> 

 <!--=========================================================================================================-->
 <center> <?php $eid='jkd';include_once "reg_inc.php";?>
<a href="cricuits.php"><button class="sunny">Back</button></a>
