...
<h2>INTRODUCTION :</h2>
<p>The Pitchers event will be a stage to be used by existing and budding entrepreneurs alike to
showcase their ideas and products in front of the jury comprising of experienced and successful
entrepreneurs and investors.
The jury and the audience will be free to ask questions and critique their business ideas and plans.
This will allow the participants to view their products and ideas from a fresh and mature perspective,
in addition to an opportunity to promote their product. <br>
<b >The winners will get a chance to get upto 1 lakh in seed funding.</b>
  ...
  <center><p>For more Information: </p><a href="work/pitchers.pdf"><button class="sunny">Download</button></a></center>


 <!--=========================================================================================================-->
 <center> <?php $eid='ptc';include_once "reg_inc.php";?>
