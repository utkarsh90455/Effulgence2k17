...
<center> <h3>MAZE SOLVER </h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Artificial intelligence will always be the centre of attraction of all. In this event we will consider the case
like blast in japan’s atomic reactor that can not be controlled by human so far. In this case the autonomous
robot with artificial intelligence can be the best solution. In this event participant has to make an
autonomous robot that should follow the line and wall while traversing the whole arena.
</p>
 <center><p>For more Information: </p><a href="work/MAZE SOLVER.pdf"><button class="sunny">Download</button></a></center>
 <!--=========================================================================================================-->
 <center><?php $eid='mzs';include_once "reg_inc.php";?>
