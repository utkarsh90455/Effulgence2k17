...
<p>This event can opens the new door to the military for surveillance purpose. In this event there will be arena on which the operator need to control their manual bots by seeing the camera view of their bot in the laptop.</p><br>

 <center><p>For more Information: </p><a href="work/ibot.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center>
  <?php $eid='ibt';include_once "reg_inc.php";?>
