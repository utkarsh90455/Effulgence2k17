...
<center> <h3>ANTARIKSHA KAUTUKAM</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Astronomy compels the soul to look upwards and leads us from this world to another. This
breathtaking contest of astronomy begins with the preliminary events of ASTROTHIRST and
PAPER PRESENTATION and will come to an end with the phenomenal event of ASTROHUNT.</p></br>


                                                                                                                                                                                                                                                                                                            


  <center><p>For more Information: </p><a href="work/astro.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center>
  <?php $eid='ant';include_once "reg_inc.php";?><a href="quiz.php"><button class="sunny">Back</button></a>
