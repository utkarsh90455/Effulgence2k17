...
<h2>INTRODUCTION :</h2>
<p>The 4th generation Programming language and Interactive environment ‘MATLAB’ hackathon in EFFULGENCE 2K17! 

Don’t have a firm grasp of the language? No worries! Links for the necessary tutorials are given below.
</p></br>
  ...
  <center><p>For more Information: </p><a href="work/matbuzz.pdf"><button class="sunny">Download</button></a></center>


 <!--=========================================================================================================-->
 <center><?php $eid='mpz';include_once "reg_inc.php";?>
