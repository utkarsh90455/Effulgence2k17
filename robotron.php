...
<div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="maze-solver.php" target=""></a>            
    </div>
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="line.php" target=""></a> 
    </div>
    
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
         ROBO WAR <span class="name"></span>
          <div class="row"></div>          
        </div>
      </div>
      ...
      <a class="link" href="ROBOWARS.php" target=""></a>  
    </div>  
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="I-BOT.php" target=""></a>       
    </div>  
    </div>
  ...
  <div class="col-lg-12 col-sm-12 col-md-12">
   <div class="col-lg-2 col-sm-2 col-md-2"></div> 
    <div class="box col-lg-3 col-sm-3 col-md-3">
      ...
      <a class="link" href="wall.php" target=""></a>              
    </div>  
    ...
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
          ROBO SOCCER <span class="name"></span>
          <div class="row"></div>         
        </div>  
      </div>
      <div class="box-overlay magictime" data-hover="rotateDown" data-return="">
      ...
      <a class="link" href="ROBOSOCCER.php" target=""></a>              
    </div>  
    
    <div class="box col-lg-3 col-sm-3 col-md-3">
      <div class="box-content">
        <div class="box-wrapper">
          DRONE-STRIFE <span class="name"></span>
          <div class="row"></div>         
        </div>  
      </div>
      <div class="box-overlay magictime" data-hover="rotateLeft" data-return="">
      ...
      <a class="link" href="dron.php" target=""></a>                    
    </div>                
