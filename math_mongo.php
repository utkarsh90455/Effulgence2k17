...
<center> <h3>MATH_MONGO</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Math_Mongo is an online mathematical coding event which gives you a great opportunity to try your hands on some exciting mathematics ranging from probability, geometry, primes to an even broader spectrum of aptitude, reasoning, deductions, number crunching and much more. 
Mathematics, here is only a means and not an end. A sound knowledge of coding is also required. So put on your thinking caps and gear up, it's time to unleash the mathematician in you. Math_Mongo is an online mathematical event which gives you a great opportunity to try your hands on some exciting mathematics ranging from probability, geometry, primes to an even broader spectrum of aptitude, reasoning, deductions, number crunching and much more.</p><br>
<p>The event will be organised on “www.hackerearth.com” . There will be six problems and each problem will have one small and another large testcase . The duration of the contest will be of 3 hours .</p><br>
<h2>NOTE-</h2>
<p>Hackerearth goodies to top 3 winners.</p><br>

<p>Date : 07-10-2017 <br>
Time : 09:00 P.M. – 12:00 A.M</p><br>

<h2> Event Co-ordinators</h2>
<p> Atul Chaturvedi (Final Year)</p>
