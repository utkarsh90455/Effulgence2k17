 ...
 <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 " >
    ...
    <div class="box col-lg-3 col-sm-12 col-md-3">
      ...
      <div class="box-overlay magictime" data-hover="puffOut" data-return="puffIn">
        <img src="img/cube.jpg" alt="" />
      </div>
      <a class="link" href="cube.php" target=""></a>            
    </div>
    ...
    <div class="box col-lg-3 col-sm-12 col-md-3">
      ...
      <a class="link" href="bridge.php" target=""></a>            
    </div>
    ...
    <div class="box col-lg-3 col-sm-12 col-md-3">
      ...
      <a class="link" href="town.php" target=""></a> 
    </div> 
    ...
    <div class="box col-lg-3 col-sm-12 col-md-3">
      ...
      <a class="link" href="goal.php" target=""></a>            
    </div>
