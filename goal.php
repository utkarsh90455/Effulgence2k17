...
<center> <h3>Hunt Ur Goal</h3> </center> 
    </div>
   <!--scoll area start-->
<div class="area mCustomScrollbar" data-mcs-theme="light" data-mcs-axis="y">

<!--=======================================================================================================-->
<p><center>“Find your destination point by given clues.”</center></p>
</br>
  ...
  <center><p>For more Information: </p><a href="work/goal.pdf"><button class="sunny">Download</button></a></center>


 <!--=========================================================================================================-->
 <center>

  <?php $eid='goa';include_once "reg_inc.php";?><a href="concretus.php"><button class="sunny">Back</button></a></center>
