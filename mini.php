...
<center> <h3>MINI MILITIA</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Each team must consist of 4 players.</br>
Game mode: Knockout Match. Minimum 3 map will be played for a team.</br>
Coin Toss is used to decide which map is to be selected. Winner will eleminate a Single map (not to
be palyed). Remainder map will be played.
</p>
<center><b >Prize : &#x20b9;1500</b></center>
</br>
  ...
  <center><p>For more Information: </p><a href="work/militia.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center>
  <?php $eid='mil';include_once "reg_inc.php";?>
