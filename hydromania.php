...
<center> <h3>HYDROMANIA</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Water that curbs the thirst can also be an element of massive destruction. Employ the principles of hydraulics to discern the mystical power and the unerring force of the fluids in the dynamic world.
HYDROMANIA brings you the opportunity to unravel the vivid theories relating to fluids, force and pressure, and put them together to bring alive a pressure-driven robot that will crash down the resolve of your rivals.</p></br>


                                                                                                                                                                                                                                                                                                            
<center><b >Prize : &#x20b9;10,000</b></center>

  <center><p>For more Information: </p><a href="work/HYDROMANIA.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center><?php $eid='hro';include_once "reg_inc.php";?>
<a href="machenical.php"><button class="sunny">Back</button></a>
