...
<center> <h3>DESIGN WAR</h3> </center> 
    </div>
   <!--scoll area start-->
...
<h2>INTRODUCTION :</h2>
<p>Designing can be best defined as the continuous effort of human to attain perfection, i.e. to define
solutions to problem which have been previously been solved in different way. This Event "Design
Wars" aims to bring out and harness the individual talent of engineering students to design and
innovate. We aim to provide the opportunity to learn and test skill in designing in a competitive
manner.
</p></br>


                                                                                                                                                                                                                                                                                                        
  <center><p>For more Information: </p><a href="work/designwar.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center><?php $eid='des';include_once "reg_inc.php";?>
