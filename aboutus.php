...
<html id="soft">
	<head>
		...
		<meta name="viewport" content="width=device-width, user-scalable=no, minimum-scale=1.0, maximum-scale=1.0">
                 <meta property="og:title" content="Effulgence 2k17 || About us" />
    <meta property="og:url" content="https://www.effgknit.com/aboutus.php" />
    ...
    <meta property="og:site_name" content="Effulgence || About us" />
		<!-- Bootstrap -->
      ...
      <ul class="nav navbar-nav abc">
        ...
        <li><a href="aboutus.php">About us</a></li>
           <li><a href="pronites.php">Pronites</a></li>
            ...
            <li id="hide2"><a href="#"> <img  src="img/neon1.png" style="margin-top:-10px;"height="60" width="60"    /></a></li>
...
<p style="">“Scientists study the world as it is; engineers create the world that has never been”.
</br></br>
Continuing the legacy, which Effulgence has been, we proudly bring forth its latest instalment Effulgence’17.
Effulgence’17 promises to present a plethora of events that would help students to enhance their skills in both technical as well as management fields.This technical extravaganza will provide ample of opportunities to the students to showcase their talents in aforementioned areas.
Since the inception, Effulgence always aimed at providing quality competitive environment, as we believe it is the best way to enhance ones knowledge and also gives him a foretaste of competition that they will face in the future.</br>
We at Effulgence have always believed that the best way to understand any concept is application and hence fostering efficient learning among students is our prime aim.</br></br>
So, come and be a part of extravaganza and feel the swag of Effulgence’17.</p>
    </div><hr/>
    <!--scroll area end-->
    </div>
