...
<h2>INTRODUCTION :</h2>
<p>Design a wired/wireless, manually controlled robot capable of overpowering its opponent in a
dual combat.</p><br>
  ...
  <center><p>For more Information: </p><a href="work/Robowars.pdf"><button class="sunny">Download</button></a></center>

 <!--=========================================================================================================-->
 <center><?php $eid='row';include_once "reg_inc.php";?>
