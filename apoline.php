...
<h2>INTRODUCTION :</h2>
<p>Skynet is trying to take control all over. You are all getting a chance to show them who should be
having control.
Skynet somehow got a bug in its communication system. You have to find the bug before they do.
As Skynet has send some troops on its own to get into our army... So you might be tested first
before going to the actual war...
So be prepared
As this comm. System is in the no man's land so we need brave soldiers...
ARE YOU BRAVE... to fight
We also think Skynet is not in the mood to leave this world ... It might come again as usual in 3
years... So here prove yourself when you have the chance.
  ...
  <center><p>For more Information: </p><a href="work/apolline.pdf"><button class="sunny">Download</button></a></center>


 <!--=========================================================================================================-->
 <center><a href="cricuits.php"><button class="sunny">Back</button></a>

  <?php $eid='apo';include_once "reg_inc.php";?></center>
